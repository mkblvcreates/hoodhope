...
module.exports = {
  ...
  resourceSubmission: {
    purpose: "Allow community organizations to submit themselves for inclusion in the resource directory.",
    endpointNote: "Submissions go to the admin queue for review. Connect to a CRM or Google Sheet for production use.",
    fields: [
      { name: "orgName", label: "Organization name", type: "text", required: true },
      { name: "contactName", label: "Primary contact name", type: "text", required: true, autocomplete: "name" },
      { name: "contactTitle", label: "Contact title / role", type: "text", required: false },
      { name: "email", label: "Email", type: "email", required: true, autocomplete: "email" },
      { name: "phone", label: "Organization phone", type: "tel", required: true, autocomplete: "tel" },
      ...
      { name: "eligibility", label: "Who is eligible for your services?", type: "text", required: true },
      { name: "languages", label: "Languages served", type: "text", required: false },
      { name: "services", label: "Describe the services you provide", type: "textarea", required: true },
      {
        name: "consentToList",
        label: "I authorize H.O.O.D. Hope to list this organization in the public resource directory after verification.",
        type: "checkbox",
        required: true,
      },
    ],
